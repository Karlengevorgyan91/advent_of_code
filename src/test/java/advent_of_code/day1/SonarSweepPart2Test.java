...
public class SonarSweepPart2Test {
    @Test
    @DisplayName("The count of depth increases must be 5, when the floor of the sea is uneven")
    public void count_of_depth_increases_must_be_5() {
        var listOfDepth = List.of(199, 200, 208, 210, 200, 207, 240, 269, 260, 263);
        var numberOfDepth = SonarSweep.count_of_depth_increases_part2(listOfDepth);

        assertEquals(5, numberOfDepth);
    }
    ...
    @Test
    @DisplayName("The count of depth increases must be 2, when the floor of  the sea is declining")
    public void count_of_depth_increases_must_be_2_when_floor_go_down() {
        var listOfDepth = List.of(199, 200, 240, 260, 300);
        var numberOfDepth = SonarSweep.count_of_depth_increases_part2(listOfDepth);

        assertEquals(2, numberOfDepth);
    }
}
